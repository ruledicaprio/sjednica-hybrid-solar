...
LOGO_SRC = os.path.join(
    BASE, "TD-OUTPUT", "3. TD JN Hibridni sistem napajanja BS Sjednica.docx"
)
...
def build():
    ...
    fr = fp.add_run(
        "PRILOG I — Specifikacija zahtjeva · BS Sjednica (Bileća) · "
        "Rev. 1, 2026 · stranica "
    )
    fr.font.size = Pt(7.5)
    ...
    # ---------------- title ------------------------------------------------
    t = doc.add_paragraph("PRILOG I TD", style="Title")
    t2 = doc.add_paragraph("SPECIFIKACIJA ZAHTJEVA", style="Subtitle")
    t3 = doc.add_paragraph()
    t3.alignment = WD_ALIGN_PARAGRAPH.CENTER
    r3 = t3.add_run(
        "Autonomni hibridni sistem napajanja — SJEDNICA "
    ...
    para(
        doc,
        "Ovaj Prilog utvrđuje tehničke zahtjeve i dokaze koje Ponuđač dostavlja "
        "UZ PONUDU kao uslov kvalifikacije — ponuda koja ih ne sadrži smatra se neprihvatljivom."
        "Prilog se čita zajedno sa Prilogom II (Obrazac za cijenu ponude) i "
        "Prilogom III (Situacija, dispozicija i grafički prilozi).",
        size=9.5,
    )
    ...
    warning(
        doc,
        "U slučaju neslaganja između dokumenata TD mjerodavni su redom: "
        "(1) Tenderska dokumentacija (TD), (2) ovaj Prilog I, (3) Prilog II (Predmjer), "
    ...
    table(
        ...
        [
            ...
            ["Priključak EES", "NE"],
            ["Bilans potrošnje", "1180 W nazivno / 1330 W maksimalno, −48 V DC"],
            ["Dostupni prostor: ", "≈150 m² (16,00 × 9,40 m)"],
            [
                "Postojeći objekat",
                "AB ploča 5,40 × 5,40 m, ograda h = 1,90 m, kapija 1,00 m",
            ],
            ["Antenski stub", "rešetkasti, h = 38 m, baza 4,20 × 4,20 m"],
            [
                "Kontejner",
                "3,00 × 2,30 m vanjski, zidni paneli 60 mm, bez opreme; "
                "ulazna vrata 900 × 2000 mm na ISTOČNOM zidu",
            ],
            [
                "Nosivost poda kontejnera",
                "10,00 kN/m² ukupno (g+p), ravnomjerno "
    ...
    table(
        ...
        [
            [
                "Vjetar",
                "qp ≥ 1,20 kN/m² (udar 3 s ≈ 45 m/s)",
                "ovjereni projekat lokacije i BAS EN 1991-1-4 + BiH NA, sa orografijom",
            ],
            [
                "Snijeg",
                "prema BAS EN 1991-1-3 + BiH NA, Zona L1-L2",
            ...
            [
                "Gustina zraka",
                "1,04–1,09 kg/m³ na 1076 m",
                "derating agregata i dimenzionisanje ventilacije",
            ],
            [
                "Tlo",
                "kamenito (krš); nosivost ≥100 kPa",
                "Ponuđač potvrđuje geomehaničkim uvidom",
            ],
            [
                "Smrzavanje",
                "temeljna spojnica ispod dubine smrzavanja",
    ...
    table(
        ...
        [
            ...
            [
                "Dejstva",
                "BAS EN 1991-1-3 (snijeg), BAS EN 1991-1-4 (vjetar), sa BiH NA",
            ],
            [
                "Beton i čelik",
                "BAS EN 1992-1-1, BAS EN 1993-1-1, BAS EN 206, EN 10025-2, EN 10219",
            ],
    ...
    # ---------------- 3. LOT 1 ---------------------------------------------
    doc.add_heading("3. LOT 1 — Infrastruktura fotonaponskih panela", 1)
    ...
    table(
        ...
        [
            ...
            [
                "Broj stringova",
                "2 stringa × 6 modula (Voc ≈309 V, Imp 13,67 A) — "
                "po jedan string na svaku od dvije rute PVDB ormara; "
                "string se prostire preko dva nosača (vidi crtež E-01)",
            ],
            [
                "Moduli",
                "12 × 585 Wp = 7,02 kWp; 4 modula po nosaču, 2 reda × 2 stupca, portret",
            ],
            ["Tip modula", "Huawei iPV585-M2A (2278 × 1134 × 30 mm)"],
            ["Nagib", "fiksno 45° — ZADRŽAN zbog decembarskog prinosa"],
            ["Azimut", "180° (JUG)"],
            [
                "Širina PV polja",
                "2305 mm (poprečna greda 2918 mm, bočni prepust 306,5 mm)",
            ],
    ...
    para(
        doc,
        "Inklinacija 45°: pri podnevnoj visini Sunca 23,6° na dan 21.12. "
    ...
    doc.add_heading("3.2 Projektna opterećenja konstrukcije", 2)
    warning(
        doc,
        "Izrada konstrukcije : Zahtijeva se CUSTOM IZRADA konstrukcije "
        "dimenzionisaa i dokazana za stvarno opterećenje lokaliteta (Tačka 3.1); ",
    )
    table(
        doc,
        ["Parametar", "Zahtjev"],
        [
            ...
            [
                "Koeficijent sile",
                "cf ≥ 1,5 pri 45° prema EN 1991-1-4 §7.3, osim uz dokaz",
            ],
            ["Površina izloženosti vjetru", "10,55 m² po nosaču"],
    ...
    doc.add_heading("3.3 Materijal i izrada", 2)
    table(
        doc,
        ["Element", "Zahtjev"],
        [
            ...
            [
                "Zavarivanje",
                "EN 1090-2, klasa izvedbe EXC2; zavarivači prema EN ISO 9606-1",
            ],
            ["Označavanje", "CE i izjava o svojstvima prema EN 1090-1"],
            ["Konstrukcijski vijci", "M16 klase 8.8, cinčani, prema EN 15048"],
            [
                "Pričvršćenje modula",
                "nehrđajući A2/A4; stezaljke za debljinu modula 30 mm",
            ],
    ...
    doc.add_heading("3.4 Sidrenje", 2)
    table(
        doc,
        ["Element", "Zahtjev"],
        [
            [
                "Tip",
                "hemijski (epoksidni/vinilesterski) anker M16 ili M20, sa ETA odobrenjem",
            ],
    ...
    table(
        ...
        [
            ...
            [
                "Dubina smrzavanja",
                "temeljna spojnica ispod dubine smrzavanja; Ponuđač navodi vrijednost",
            ],
        ],
        widths=[4.0, 12.6],
    )
    ...
    table(
        ...
        [
            ["Snaga", "22 kVA / 17,6 kW standby, 400/230 V, 50 Hz"],
            ["Referentni tip", "FG Wilson P22-6 ili ekvivalent"],
            ["Motor", "Perkins 404D-22G ili ekvivalent, 4-cilindarski, 1500 o/min"],
            ["Izvedba", "za montažu u prostor"],
            ["Dimenzije", "1550 × 620 × 1020 mm (referentno +/-5%)"],
            ["Masa", "378 kg suho / 385 kg mokro (referentno)"],
            ["Derating na 1076 mnv i temperaturu okoline do +40 °C (ISO 3046-1)"],
            [
                "Uzbuda (OBAVEZNO)",
            ...
            [
                ...
                "vlastita frekvencija ≤8 Hz; sa fleksibilnim priključcima",
            ],
        ],
        widths=[4.6, 12.0],
    )
    figures(
        ...
        [
            (
                os.path.join(FIG, "genset_side.png"),
                9.2,
                " FG Wilson P22-6, bočni pogled",
            ),
            (
                os.path.join(FIG, "genset_front.png"),
                4.8,
    ...
    for b in [
        ...
        "referentne dimenzije 1050 × 600 × 1310 mm, masa cca 170 kg — "
        "pun ≈590 kg na 0,63 m² = 9,2 kN/m²; unutar projektnih 10,00 kN/m², "
        "OBAVEZAN čelični ram/roštilj za raznošenje opterećenja i pod spremnikom "
        "(vidi Tačku 4.8)",
    ...
    figures(
        ...
        [
            (
                os.path.join(FIG, "tank_side.png"),
                7.4,
                "Slika 3 — Spremnik goriva 500 l, bočni izgled (ilustrativno)",
            ),
            (
                os.path.join(FIG, "tank_top.png"),
                8.6,
                "Slika 4 — Spremnik goriva 500 l, pogled od vrha (ilustrativno)",
            ),
        ],
    )
    ...
    para(
        doc,
        "Dimenzionisano prema tehničkom listu proizvođača. Mjerodavno ograničenje "
    ...
    table(
        ...
        [
            [
                "Zrak hladnjaka",
                "1980 m³/h (33 m³/min) — ostvaruje vlastiti ventilator hladnjaka",
            ],
            ...
            ["Usisna žaluzina", "500 × 700 mm (v ≈ 3,4 m/s, Δp ≈ 16 Pa)"],
            ["Kanal hladnjaka", "limeni kanal ≈6 m², od pocinčanog lima d = 1 mm"],
            ["Izlazna žaluzina", "600 × 600 mm (Δp ≈ 15 Pa)"],
            [
                "Ventilator prostora",
                "1200 m³/h, Ø315, vođen termostatom i kontrolerom DEA, blokiran sa radom DEA",
            ],
    ...
    table(
        ...
        [
            [
                "Usisna žaluzina 500 × 700",
                "JUŽNI zid, desno; donja ivica +0,30 m od poda",
            ],
            [
                "Kanal hladnjaka + izlazna žaluzina 600 × 600",
                "ZAPADNI zid, na osi hladnjaka agregata; kanal najkraćim putem od "
                "hladnjaka agregata kroz kontejner",
            ],
            ["Izduv", "uz ZAPADNI zid, završetak iznad krova (Tačka 4.4)"],
            ["Odušna cijev spremnika", "SJEVERNI zid, prema istoku"],
            [
                "Ventilator prostora Ø315",
                "ISTOČNI zid, gore (donja ivica ≈+1,75 m), sjeverno od ulaznih vrata",
            ],
            [
                "Minimalna razdaljina",
                "≥3 m prostorno između usisa zraka, izduva i odušne cijevi",
            ],
        ],
        widths=[5.6, 11.0],
    )
    figures(
        ...
        [
            (
                os.path.join(FIG, "layout_m01.png"),
                16.0,
                "Slika 5 — Raspored opreme i otvora u kontejneru: "
                "(usis JUG → agregat → izlaz ZAPAD). Crteža M-01, Prilog III",
            )
        ],
    )
    warning(
        doc,
        "Otvori se izvode kroz ZIDNE PANELE kontejnera,Raspored je ukrsni (usis JUG → agregat → izlaz ZAPAD) i "
        ...
        "MTS9302. Dozvoljava se promjena rasporeda otvora, uz proračun "
        "recirkulacije i temperaturnog uticaja i saglasnost NO "
        "Kupca.",
    )
    ...
    table(
        ...
        [
            ...
            [
                "Prečnik",
                "DN 65 — USVOJENO (Predmjer, stavka 4.11). DN 50 zadovoljava "
            ...
            [
                "Završetak",
                "iznad krova, usmjeren naviše, ≥3 m od usisa zraka i odušne cijevi",
            ],
    ...
    doc.add_heading("4.5 Elektroinstalacije i zaštite", 2)
    warning(
        doc,
        "Zahtijeva se NEZAVISNA POBUDA generatora (PMG ili AREP/AUX) sa 3 × In u trajanju ≥10 s "
        "(Tačka 4.1), kao i zaštita ZS sklopkom kao drugi nivo zaštite.",
    )
    table(
        doc,
        ["Element", "Zahtjev"],
        [
            ...
            [
                "Sistem uzemljenja",
                "TN-S, jedinstvena tačka spajanja N i PE u novom GRO",
            ],
            ["Glavna zaštita", "4p RCD 63 A / 300 mA, S-tip (selektivna)"],
            [
                "Krajnji strujni krugovi",
                "2 × RCBO 16 A / 30 mA, tip A (utičnice, rasvjeta)",
            ],
            ["Nazivna struja", "In = 31,75 A pri 22 kVA / 400 V"],
            [
                "Sklopka izvora",
                "4p 63 A, položaji 1 – agregat / 0 – isključeno / 2 – rezerva",
            ],
            ["SPD, AC strana", "tip 1 + 2 (Iimp ≥12,5 kA) — objekat ima vanjski LPS"],
            [
                "SPD, DC strana",
                "tip 2 po stringu (Iimp ≥5 kA, Ucpv ≥425 V), na PVDB i na polju",
            ],
            ...
            [
                ...
                "signalna rasvjeta antenskog stuba (K7) na zasebnom "
    ...
    doc.add_heading(
        "4.6 Parametriranje upravljanja i nadzora radom DEA <--> PV + Baterija", 2
    )
    for b in [
        "start agregata prema stanju napunjenosti baterija (SoC), a ne prema "
    ...
    for b in [
        "elaborat zaštite od požara za prostor sa 500 l dizel goriva — prije izvođenja",
    ...
    para(
        doc,
        "Elaborat zaštite od požara, protupožarni ventil na spremniku i "
    ...
    # ---------------- 5. proofs --------------------------------------------
    doc.add_heading("5. Dokazi koji se dostavljaju uz ponudu: oznaka PONUDA", 1)
    warning(
        doc,
        "Dokazi koji se dostavljaju NO u toku realizacije: oznaka REALIZACIJA. "
        "Dokazi koji se dostavljaju NO tokom primopredaje: oznaka PRIMOPREDAJA.",
    )
    table(
        doc,
        ["Br.", "Dokaz", "LOT", "Status"],
        [
            [
                "1",
                "Statički proračun nosive konstrukcije i temelja za qp ≥ 1,20 kN/m² pri "
                "45°, ovjeren i potpisan od ovlaštenog inženjera, sa dokazom na "
                "podizanje i prevrtanje",
                "1",
                "REALIZACIJA",
            ],
            ["2", "Tečnički nacrti konstrukcije i temelja", "1", "PONUDA"],
            [
                "3",
                "Izjava o svojstvima prema EN 1090-1 i klasa izvedbe EXC2",
                "1",
                "REALIZACIJA",
            ],
            [
                "4",
                "Atesti materijala (čelik) i potvrda o vrućem cinčanju (debljina sloja)",
                "1",
                "REALIZACIJA",
            ],
            [
                "5",
                "ETA certifikat i proračun za hemijska sidra",
                "1",
                "REALIZACIJA",
            ],
            [
                "6",
                "Zapisnik o ispitivanju ankera na čupanje (min. 10 %)",
                "1",
                "PRIMOPREDAJA",
            ],
            [
                "7",
                "Tehnički list (TDS) agregata sa dokazom o PMG/AREP nezavisnoj pobudi (3 × In, ≥10 s)",
                "2",
                "PONUDA",
            ],
            [
                "8",
                "Proračun pada pritiska ventilacije i protutlaka izduvnog sistema",
                "2",
                "REALIZACIJA",
            ],
            [
                "9",
                "Elaborat zaštite od požara za prostor sa rezervoarom 500 l",
                "2",
                "REALIZACIJA",
            ],
            [
                "10",
                "Atesti i certifikati za elektro opremu, CPR kablove i prenaponsku zaštitu (SPD)",
                "2",
                "REALIZACIJA",
            ],
            [
                "11",
                "Ispitni protokoli elektroinstalacija i otpora uzemljenja (≤10 Ω)",
                "2",
                "PRIMOPREDAJA",
            ],
            [
                "12",
                "Protokol o parametriranju i funkcionalnom ispitivanju integracije DEA–PV–baterija",
                "2",
                "PRIMOPREDAJA",
            ],
        ],
        widths=[1.0, 10.4, 1.8, 3.4],
    )
    # ---------------- 6. tests ---------------------------------------------
    ...
    table(
        ...
        [
            ...
            [
                "Funkcionalno ispitivanje RCD",
                "vrijeme i struja isključenja prema IEC 61008/61009",
            ],
            ["Ispitivanje ventilacije", "izmjereni pad pritiska ≤125 Pa"],
            [
                "Funkcionalno ispitivanje agregata",
                "automatski start/stop, zaštite, alarmi",
            ],
            ["Probni rad", "72 h neprekidnog rada sa simulacijom opterećenja"],
            [
                "Mjerenje temperature prostora",
                "pri radu agregata na nazivnom opterećenju",
            ],
        ],
        widths=[6.0, 10.6],
    )
    ...
    r = p.add_run(
        "Autor: Rusmir Skopljak, dipl. ing. el.\n"
